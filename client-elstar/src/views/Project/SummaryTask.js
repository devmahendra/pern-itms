...
const SummaryTask = () => {
  ...
  const getData = async () => {
    try {
      const response = await fetch("http://localhost:5002/projects/task-status");
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-5 gap-5 mb-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <div className="flex gap-1.5 items-end mb-2">
              <h3 className="font-bold leading-none text-white">{data?.total_task}</h3>
            </div>
      ...
      <Card className="bg-gray-700">
        <div className="flex items-center gap-4">
          ...
          <div>
            <div className="flex gap-1.5 items-end mb-2">
              <h3 className="font-bold leading-none text-white">{data?.new_task}</h3>
            </div>
            <p className="flex items-center gap-1 text-white">
              <span>New Tasks</span>
            </p>
      ...
      <Card className="bg-gray-700">
        <div className="flex items-center gap-4">
          ...
          <div>
            <div className="flex gap-1.5 items-end mb-2">
              <h3 className="font-bold leading-none text-white">{data?.ongoing_task}</h3>
            </div>
            <p className="flex items-center gap-1 text-white">
      ...
      <Card className="bg-gray-700">
        <div className="flex items-center gap-4">
          ...
          <div>
            <div className="flex gap-1.5 items-end mb-2">
              <h3 className="font-bold leading-none text-white">{data?.expired_task}</h3>
            </div>
            <p className="flex items-center gap-1 text-white">
      ...
      <Card className="bg-gray-700">
        <div className="flex items-center gap-4 ">
          ...
          <div>
            <div className="flex gap-1.5 items-end mb-2">
              <h3 className="font-bold leading-none text-white">{data?.completed_task}</h3>
            </div>
            <p className="flex items-center gap-1 text-white">
